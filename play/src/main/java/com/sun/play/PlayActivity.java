...
import com.sun.libffmpeg.utils.Logger;
import com.sun.play.base.MyApp;
import com.sun.play.player.AudioVisualConverter;
import com.sun.play.player.MyMediaPlayer;
import com.sun.play.utils.MusicFileHelper;
import com.sun.play.utils.UriHelper;
import com.sun.play.view.AudioView;
...
public class PlayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityCompat.requestPermissions(PlayActivity.this, PERMISSIONS, 1);
        initView();
        initEvent();
    }
    ...
    private void initView() {
        ...
        ivSwitch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(PlayActivity.this, Mp3Activity.class));
                finish();
            }
        });
    }
